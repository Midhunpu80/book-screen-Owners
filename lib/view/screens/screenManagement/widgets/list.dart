      ...
      child: Container(
        ...
        child: ListView.separated(
            itemBuilder: (context, index) {
              ...
              final w = screemanagedata.repy.data[index];
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          allscreenMnagedatas(txt: w.screen.toString()),
                          allscreenMnagedatas(txt: w.columns.toString()),
                          allscreenMnagedatas(txt: w.totalSeats.toString()),
                          IconButton(
                              onPressed: () {
            ...
            itemCount: screemanagedata.reply.data.length),
      ),
    ),
  );
}
